...
params.reads = "fastq_sample/*_{1,2}.fastq"
...
params.reapeatreads = "fastq_sample/*_{1,2}.fastq"
untrimmed_reads_ch = Channel.fromFilePairs(params.reapeatreads)

//3
process BB_Trim {
    conda '-c agbiome bbtools'
...
process AntismashContigs {
    ...
    script:
    """
    antismash $contig --genefinding-tool prodigal 
    """
}
//--output-dir $contig
