...
params.sample_basename = "ERX1365478_T1"
params.input = "batch11_20/fastq/ERX1365478_T1/*_{1,2}.fastq.gz"
params.type = "crc"
...
process BB_Trim {
    ...
    //publishDir "results_${params.type}_${params.sample_basename}/trimmed_reads", mode:'copy', pattern: "*.fastq.gz"
