...
#!!!Rename input file!!!
antismash_bgcs <- read.table(file = '~/thesis/python_r/1final_data/30scaff_work_files/crc_scaffolds_unified_30.output.tsv', sep = '\t')
antismash_bgcs
...
#csv type
write.table(clean, file='~/thesis/python_r/1final_data/30scaff_work_files/crc_scaffolds_unified_30_processed.csv', quote=FALSE, sep=',', col.names = NA)
```
...
################################
#crc in
crc_csv <- read.csv(file = '~/thesis/python_r/1final_data/30scaff_work_files/crc_scaffolds_unified_30_processed.csv', sep = ',')
crc_csv
#normal in
normal_csv <- read.csv(file = '~/thesis/python_r/1final_data/30scaff_work_files/normal_scaffolds_unified_30_processed.csv', sep = ',')
normal_csv
...
#write to new tsv
write.table(merged_tsv, file='~/thesis/python_r/1final_data/30scaff_work_files/30scaff_readygraph.csv', quote=FALSE, sep=',', col.names = NA)
```
...
rb <- ggplot(g, aes(x = Cluster_type, y=Cluster_count, fill=CRC_or_Normal)) +
  ...
  scale_x_discrete(expand=c(0,0)) +
   ggtitle("MetasSpades Scaffolding BGCs") +
  xlab("BGC Type") +
  ylab("BGC Count") +
